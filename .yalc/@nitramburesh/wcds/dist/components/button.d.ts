...
import { ButtonType, ButtonVariant, ColorScheme, Icon, Size } from '../types';
/**
 * @tagname wcds-button
 ...
 */
export declare class WCDSButton extends LitElement {
    id: string;
    size: Size;
...
export type WCDSButtonAttributes = 'id' | 'size' | 'variant' | 'colorScheme' | 'iconLeft' | 'iconRight' | 'disabled' | 'type';
export type WCDSButtonEvents = {
    'click': MouseEvent;
};
